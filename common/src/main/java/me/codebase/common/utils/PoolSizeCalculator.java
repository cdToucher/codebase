 ...
 */
public abstract class PoolSizeCalculator {//NOSONAR
     ...
     */
    public void calculateBoundaries(BigDecimal targetUtilization,
                                       BigDecimal targetQueueSizeBytes) {//NOSONAR
    ...
    private void calculateOptimalCapacity(BigDecimal targetQueueSizeBytes) {//NOSONAR
    ...
    private void calculateOptimalThreadCount(long cpu, long wait,
                                             BigDecimal targetUtilization) { //NOSONAR
     ...
     */
    public void start(Runnable task) {//NOSONAR
        long start = 0;
        int runs = 0;
        do {
            if (++runs > 5) {
    ...
    private void collectGarbage(int times) {// NOSONAR
     ...
     * pools work queue
     */
    public long calculateMemoryUsage() { //NOSONAR
